...
**skillhub** plugs into your stack through [`cognis-connect`](https://github.com/cognis-digital/cognis-connect),
...
Once `skillhub` emits JSON findings, pipe them straight to a destination — `--dry-run`
