"""SKILLHUB core — Local skill registry and installer for AI agents."""
...
RULES = [
    ("SKI-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SKI-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SKI-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
