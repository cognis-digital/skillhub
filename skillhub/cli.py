"""SKILLHUB command-line interface."""
from __future__ import annotations
import argparse, sys
from skillhub.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="skillhub", description="SKILLHUB — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from skillhub.mcp_server import serve
        return serve()
    if args.cmd == "scan":
