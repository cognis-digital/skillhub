#!/usr/bin/env sh
# Universal installer for skillhub. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/skillhub.git"
